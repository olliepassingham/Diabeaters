...
export function WidgetLibrary({ widgets, onToggleWidget, onMoveWidget, onResizeWidget, onReorderWidgets, onClose }: WidgetLibraryProps) {
  ...
  return (
    <Card className="dashboard-card-hover rounded-xl border-primary/50 bg-white/80 dark:bg-neutral-900/70 border-neutral-200/60 dark:border-neutral-700/50 shadow-sm" data-testid="widget-library">
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between gap-2">
          ...
          <Button variant="ghost" size="icon" onClick={onClose} className="focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-neutral-900 dark:focus-visible:ring-neutral-200" data-testid="button-close-library" aria-label="Close customise dashboard">
            <X className="h-4 w-4" />
          </Button>
        </div>
      </CardHeader>
