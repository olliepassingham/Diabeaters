...
export function DiscoveryPrompt() {
  ...
  return (
    <Card className="dashboard-card-hover dashboard-card-scale bg-white/80 dark:bg-neutral-900/70 border-neutral-200/60 dark:border-neutral-700/50 shadow-sm" data-testid="widget-discovery-prompt">
          ...
          <div className="flex-1 min-w-0 space-y-2">
            <div className="flex items-start justify-between gap-2">
              ...
              <Button
                ...
                aria-label="Dismiss discovery prompt"
              >
                <X className="h-4 w-4" />
              </Button>
            </div>
