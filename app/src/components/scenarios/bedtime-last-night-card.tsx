  ...
  return (
    <Collapsible open={open} onOpenChange={setOpen}>
      <Card
        ...
        data-testid="card-bedtime-last-night"
      >
          ...
          >
            <div className="flex items-center gap-3 px-4 py-3 sm:px-5">
              ...
              <div className="min-w-0 flex-1">
                ...
                {!open ? (
                  <span className="mt-0.5 block line-clamp-2 text-sm text-muted-foreground" data-testid="text-bedtime-last-night-preview">
                    {preview}
                  </span>
                ) : insight ? (
                  ...
                  <span className="mt-0.5 block text-sm text-muted-foreground">
                    Overnight glucose review from your connected CGM
                  </span>
                )}
              </div>
