...
export { fetchLatestCgmReading, connectHealthPlatformCgm, connectDexcomShareCgm, disconnectDexcomShareCgm, listCgmAdapters, getCgmAdapter, prioritizeCgmAdapterIds, cgmAdapterAttemptBudgetMs } from "./registry";
