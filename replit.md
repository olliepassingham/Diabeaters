...
- **First Win**: Personalised screen showing value for chosen path with CTA routing to the relevant page (supplies→/supplies, meals→/adviser?tab=meal, exercise→/adviser?tab=exercise, overview→/)
...
- **Activity Adviser**: Meal planning with exercise integration, Exercise planning with recovery guidance, Activity Session planner for complete workout day management, Routines tab, Ratios tab (Ratio Adviser guided questionnaire for pattern recognition), and Tools tab (Hypo Treatment Calculator). Features conversation memory, time-of-day awareness (auto-uses correct meal ratios), historical learning from activity logs, and confidence indicators on recommendations.
