-- Feed: post images (jsonb paths), relaxed body constraint, report flags, pagination RPC, storage bucket.
-- Apply after docs/sql/community.sql and docs/sql/community_social_v2.sql.
