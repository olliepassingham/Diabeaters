#!/usr/bin/env python3
"""Export polished horizontal carousel cover from master + real brand mark."""
...
MASTER = BRANDING / "master-carousel-horizontal.png"
MARK = BRANDING / "diabeaters-mark.png"
OUT = BRANDING / "instagram-carousel-cover-diabeaters.png"
OUT_2X = BRANDING / "instagram-carousel-cover-diabeaters@2x.png"

# Logo placement tuned for 1536×1024 master (header row, left of wordmark).
MARK_HEIGHT = 54
MARK_X = 118
MARK_Y = 52
...
def composite_mark(base: Image.Image) -> Image.Image:
    ...
    # Cover previous logo glyph with sampled header background.
